...
{
    public partial class YearlyCost : BaseForm
    {
        public YearlyCost()
        {
            InitializeComponent();
        ...
        {
            string query = "SELECT *  ,i.BuyingPrice * i.Quantity AS Total FROM InventoryTbl AS i JOIN CategoryTbl AS c ON i.CategoryId = c.id WHERE YEAR(Date) = " + currentYear + "";
